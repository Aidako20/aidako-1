...
<span lang="shell" class="line" id="LC6"><span class="nb">sudo </span>git clone https://www.github.com/odoo/odoo --depth 1 --branch 16.0 /opt/odoo/odoo</span>
...
<span lang="shell" class="line" id="LC6"><span class="nb">sudo </span>mv aidako-1-16 odoo</span>
...
<div><span lang="shell" class="line" id="LC21">sudo certbot --nginx -d your_domain.conf </span></code></pre></div>
<div><span lang="shell" class="line" id="LC21">sudo nano /etc/nginx/sites-available/yourdomain.conf </span></code></pre></div>
